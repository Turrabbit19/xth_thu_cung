    ...
    <form method="post" action="index.php?act=add-pro" enctype="multipart/form-data" class="pb-5 mt-4 ms-4 me-4">
        ...
        <div class="row">
            ...
            <div class="">
                ...
                <input type="text" class="form-control rounded-0" id="inputEmail4" placeholder="Nhập giá bán" name="price_old" />
            </div>
            <div class="">
                <label for="inputEmail4" class="form-label">Giá mới</label>
                <input type="text" class="form-control rounded-0" id="inputEmail4" placeholder="Nhập giá bán" name="price_new" />
            </div>
            <div class="mt-3">
            ...
            <div class="mt-3">
                ...
                <div class="row ps-3 pt-2">
                    ...
                    <div class="form-check col-5">
                        <input class="form-check-input" type="radio" name="status" value="2" id="2" checked />

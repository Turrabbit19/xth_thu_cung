                ...
                <div class="col-3">
                    <div class="border rounded-3 mb-3 overflow-hidden">
                        ...
                        <div class="bg-danger ratio-1x1">
                            <img src="img/san-pham/sanpham1.png" alt="" class="mw-100 mh-100">
                        </div>
                        <!-- Text và button -->
                        <div class="p-2">
                            <h5><?= $pro->name ?></h5>
                            <div class="d-flex justify-content-between">
                                <span class="text-danger text-decoration-line-through">9,000,000 VNĐ</span>
                                <span class="fw-bold"><?= number_format("$pro->price") ?> VNĐ</span>
                            </div>
